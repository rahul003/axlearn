...
class TestConfigBuilder:
    ...
    def with_expert_settings(self, hidden_dim, outer_batch, num_groups, num_experts, top_k=2, train_capacity_factor=None, use_blockwise_kernel=False, block_size=None):
        self.params.update({
    ...
    def build_test_configs_integ(self):
        ...
        test_configs.append(
            TestConfig(
                ...
                golden=ModuleConfig(TransformerFeedForwardMoE, "neuron", "MoE", self.params['dtype']),
    ...
    def build_grid_space(self):
        ...
        # 150B configs
        Mistral150B_base = (16, 4096, 6144, 15360, 16, 4, 1, 4, 2, {"fsdp":-1, "model":16}, "bfloat16")
...
def get_training_configs(is_unit: bool = False, is_blockwise: bool = False):
    ...
    for (batch, seq, input_dim,  hidden_dim, n_experts, top_k, n_groups,
        ...
        config = config.with_expert_settings(
            ...
            n_experts,
            top_k,
            use_blockwise_kernel=is_blockwise,
