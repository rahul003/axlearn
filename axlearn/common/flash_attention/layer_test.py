...
class TestFlashAttention(TestCase):
    ...
    def test_forward(
        ...
        with Mesh(mesh_utils.create_device_mesh(mesh), mesh_axis_names):
            ...
            def ref_forward_pass(layer, params, inputs, prng_key):
                return F(
                    layer,
                    prng_key=prng_key,
                    state=params,
            ...
            def test_forward_pass(layer, params, inputs, prng_key):
                return F(
                    layer,
                    prng_key=prng_key,
                    state=params,
