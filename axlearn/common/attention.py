...
class TransformerLayer(BaseTransformerLayer):
    ...
    def _forward_for_mode(
        ...
        *,
        ...
        # # Uncomment to log self-attention outputs 
        # if context and mode == ForwardMode.FORWARD:
        #     context.add_summary(f"{self.path()}/self_attn", data)
        ...
        # Logs the transformer layer outputs 
        data = self.feed_forward(data)
        if context and mode == ForwardMode.FORWARD:
            context.add_summary(f"{self.path()}/ffn", data)
