...
class MultiheadAttention(BaseLayer):
    ...
    def _forward_for_mode(
        ...
        *,
        ...
        q_proj = with_sharding_constraint(q_proj, PartitionSpec(("data", "expert", "fsdp"), "seq", "model", None))
        k_proj = with_sharding_constraint(k_proj, PartitionSpec(("data", "expert", "fsdp"), None, "model", None))
        v_proj = with_sharding_constraint(v_proj, PartitionSpec(("data", "expert", "fsdp"), None, "model", None))
        ...
        context = with_sharding_constraint(context, PartitionSpec(("data", "expert", "fsdp"), "seq", "model", None))
        probs = with_sharding_constraint(probs, PartitionSpec(("data", "expert", "fsdp"), "model", "seq", None))
        ...
        o_proj = with_sharding_constraint(o_proj, PartitionSpec(("data", "expert", "fsdp"), "seq", None))
